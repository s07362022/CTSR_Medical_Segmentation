...
def _resnet(arch, block, layers, pretrained, **kwargs):
    ...
    if pretrained:
        state_dict = torch.load("pretrained/%s.pth" % arch)#("pretrained/%s.pth" % arch) #'/home/u5914116/Harden/SOTA_papper_code/ST-PlusPlus-master/outdir/models/pascal/663/deeplabv3plus_resnet50_27.17.pth'
...
def resnet50(pretrained=False): #Harden/SOTA_papper_code/ST-PlusPlus-master/outdir/models/pascal/663/deeplabv3plus_resnet50_52.76.pth
